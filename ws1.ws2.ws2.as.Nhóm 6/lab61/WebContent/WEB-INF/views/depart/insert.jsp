...
<c:if test="${user1.username.length()>0}">
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header" style="text-align: center; ">thêm phòng ban </h1>
			</div>
		</div><!--/.row-->
		<form:form style="margin-left: 400px; " action="depart/insert.htm" modelAttribute="depart" >

<div class="control-group">
      <!-- Username -->
      <label class="control-label"  for="username">id</label>
      <div class="controls">
      <form:input path="id"  class="input-xlarge"/>
