	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">cập nhâp  phòng ban </li>
			</ol>
		</div><!--/.row-->
		
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header" style="text-align: center; ">cập nhâp  phòng ban </h1>
			</div>
		</div><!--/.row-->
		<form:form style="margin-left: 400px; " action="depart/update.htm" modelAttribute="depart" >

<div class="control-group">
      <!-- Username -->
      <label class="control-label"  for="username">id</label>
      <div class="controls">
      <form:input path="id"  value="${name}" class="input-xlarge"/>
     ...
     <label class="control-label" for="password">name</label>
      <div class="controls">
      <form:input path="name" value="${password}"   class="input-xlarge" />
