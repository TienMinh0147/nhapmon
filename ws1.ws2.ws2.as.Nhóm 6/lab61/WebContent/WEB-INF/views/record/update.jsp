	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">cập nhâp thành tích và kỷ luật  </li>
			</ol>
		</div><!--/.row-->
		
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header" style="text-align: center; ">cập nhâp thành tích và kỷ luật</h1>
			</div>
		</div><!--/.row-->
...
<div class="control-group">
    ...
    <form:input path="staff.id" value="${name }"/>
     ...
     <label class="control-label" for="password">Loại</label>
      <div class="controls">
      <c:if test="${type == true}">
 <form:radiobutton path="type" value="true" label="Thành tích" checked="checked"/>
...
<form:radiobutton path="type" value="false" label="Kỷ luật" checked="checked"/>
</c:if>
