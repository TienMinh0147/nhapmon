	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">quản lý  thành tích và kỷ luật </li>
			</ol>
		</div><!--/.row-->
		
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">quản lý  thành tích và kỷ luật</h1>
			</div>
		</div><!--/.row-->
	<table class="table">
...
<li><a href="${pageContext.request.contextPath}/record/insert.htm"> thêm  kỷ luật và thành tích</a></li>
			<div class="col-sm-12">
