...
<body>
 <c:if test="${user1.username.length()>0}">
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header" style="text-align: center; ">thêm tài khoản </h1>
			</div>
		</div><!--/.row-->
		<form:form style="margin-left: 400px; " action="user/insert.htm" modelAttribute="users" >

<div class="control-group">
      <!-- Username -->
      <label class="control-label"  >Username</label>
      <div class="controls">
      <form:input path="username" name="name" class="input-xlarge"/>
     ...
     <label class="control-label" >Password</label>
      <div class="controls">
      <form:input path="password"  name="name1" type="password" class="input-xlarge" />
       
        <p class="help-block" style="color: red;">${message1}</p>
      </div>
