...
<c:if test="${user1.username.length()>0}">
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<form:form style="margin-left: 400px; " action="list1.htm"  >
<label> tìm kiếm tên</label>
<input name="tim" type="search"/>
</form:form>
	<table class="table">
...
<tr>
	...
	<td>${s.notes}</td>
	<td>${s.depart.name}</td>
<td><a href="staff/update/${s.id}.htm">update</a></td>
...
<li><a href="${pageContext.request.contextPath}/staff/insert.htm"> thêm  nhân viên</a></li>
			<div class="col-sm-12">
