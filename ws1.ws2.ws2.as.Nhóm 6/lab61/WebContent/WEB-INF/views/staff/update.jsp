	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">cập nhâp nhân viên  </li>
			</ol>
		</div><!--/.row-->
		
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header" style="text-align: center; ">cập nhâp nhân viên</h1>
			</div>
		</div><!--/.row-->
		<form:form style="margin-left: 400px; " action="staff/update.htm" modelAttribute="staff" >
...
<form:radiobutton path="gender" value="false" label="nữ"/>
	...
	<div class="control-group">
      ...
      <div class="controls">
      <form:input path="birthday" name="birthday" type="date"   value="${birthday }" />
      </div>
    </div>
    <div class="control-group">
      <!-- E-mail -->
      ...
      <div class="controls">
     <form:input path="photo" type="file"   value="${photo }"/>
      </div>
    </div>
    <div class="control-group">
      <!-- E-mail -->
    ...
    <div class="control-group">
      ...
      <div class="controls">
    <form:input path="salary" type="number"   value="${salary }"/>
      </div>
    </div>
    <div class="control-group">
      <!-- E-mail -->
      ...
      <div class="controls">
    <form:input path="notes"   value="${notes }" />
      </div>
    </div>
    <div class="control-group">
      <!-- E-mail -->
